  ...
  Our Doctors
        ...
        <div className="flex justify-center items-center">
          ...
          <div className="text-center bg-white p-4 rounded-lg shadow-md w-60">
            <img
              src={mamatha} // Use the correct image path
              alt="mamatha - General Medicine Specialist"
              className="mx-auto w-40 h-40 rounded-full object-cover"
            />
            <h3 className="text-xxx font-bold text-blue-800 mt-4">Dr. Mamatha</h3>
          </div>
           <div className="text-center bg-white p-4 rounded-lg shadow-md w-60">
            <img
              src={swarna} // Use the correct image path
              alt="swarna - General Medicine Specialist"
              className="mx-auto w-40 h-40 rounded-full object-cover"
            />
            <h3 className="text-xxx font-bold text-blue-800 mt-4">Dr. Swarnarekha</h3>
          </div>
        </div>
      </section>
    </div>
